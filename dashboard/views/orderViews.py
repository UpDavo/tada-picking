...
class ClientOrdersList(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        page_obj, fields, object_data, list_url = ClientService.getOrderList(
            self.request, name)

        context['nombre'] = "Órdenes"
        context['busqueda'] = "número de órden"
        context['key'] = "none"
